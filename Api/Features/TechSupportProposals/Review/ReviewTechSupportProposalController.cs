...
namespace AcademicGateway.Api.Features.TechSupportProposals.Review;
...
[ApiController]
[Route("api/project-instances/{projectInstanceId:guid}/tech-support-proposals/{proposalId:guid}/review")]
public class ReviewTechSupportProposalController(ISender mediator) : ControllerBase
{
    ...
    /// <param name="proposalId">The unique tracking identifier of the corporate tech support proposal being evaluated from the route segment.</param>
