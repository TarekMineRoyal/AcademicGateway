...
namespace AcademicGateway.Api.Features.SupervisionRequests.Commands.ReviewSupervisionRequest;
...
public class ReviewSupervisionRequestController(ISender mediator) : ControllerBase
{
    ...
    /// <param name="supervisionRequestId">The unique tracking identifier of the specific supervision invitation being evaluated from the route segment.</param>
    ...
    /// <returns>A 204 No Content response confirming that the aggregate state machine has been synchronized.</returns>
    [HttpPut]
    ...
    public async Task<IActionResult> Review(
        ...
        [FromRoute] Guid supervisionRequestId,
