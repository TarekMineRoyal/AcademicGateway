...
public class ProjectTemplate : BaseEntity
{
    ...
    /// <summary>
    /// Gets the optional unique identifier of the target academic major for semantic vector filter scanning.
    /// </summary>
    public Guid? MajorId { get; private set; }

    /// <summary>
    /// Gets the optional unique identifier of the target academic specialty for semantic vector filter scanning.
    /// </summary>
    ...
    /// <param name="majorId">Optional structural filter property mapping to a target academic major track.</param>
    /// <param name="specialtyId">Optional structural filter property mapping to a target academic specialty track.</param>
    ...
    // ==========================================
    // ACADEMIC ALIGNMENT (MUTATORS)
    // ==========================================

    /// <summary>
    /// Modifies optional academic alignment filters (Major and Specialty) attached to this template blueprint.
    /// </summary>
    /// <param name="majorId">The optional target major identifier.</param>
    /// <param name="specialtyId">The optional target specialty identifier.</param>
    /// <exception cref="InvalidTemplateStatusException">Thrown if the aggregate root is locked from lifecycle edits.</exception>
    public void UpdateAcademicAlignment(Guid? majorId, Guid? specialtyId)
    {
        if (Status == ProjectTemplateStatus.Approved || Status == ProjectTemplateStatus.Rejected)
        {
            throw new InvalidTemplateStatusException(Status, nameof(UpdateAcademicAlignment));
        }
