...
/// and exception resilience of the <see cref="ProjectTemplateReviewerChangesRejectedEventHandler"/> class.
/// </summary>
public class ProjectTemplateReviewerChangesRejectedEventHandlerTests
{
    private readonly Mock<ILogger<ProjectTemplateReviewerChangesRejectedEventHandler>> _loggerMock;
    private readonly ProjectTemplateReviewerChangesRejectedEventHandler _handler;

    /// <summary>
    /// Initializes a new instance of the <see cref="ProjectTemplateReviewerChangesRejectedEventHandlerTests"/> class,
    /// establishing isolated mocking boundaries for infrastructure-level diagnostic dependencies.
    /// </summary>
    public ProjectTemplateReviewerChangesRejectedEventHandlerTests()
    {
        _loggerMock = new Mock<ILogger<ProjectTemplateReviewerChangesRejectedEventHandler>>();
        _handler = new ProjectTemplateReviewerChangesRejectedEventHandler(_loggerMock.Object);
    }

    /// <summary>
    /// Validates the happy path and structural branch path conditions by processing various 
    /// event configurations, confirming that structural diagnostic telemetry is written exactly once at warning level.
    /// </summary>
    ...
    [Theory]
    [InlineData("9ad957e0-855b-4b12-4ad4-288b47781042", "0bf627f1-1111-4b12-8ad4-288b47781043", "Standard provider rejection of proposed reviewer corrections scenario.")]
        ...
        string? scenario)
    {
        ...
        ProjectTemplateReviewerChangesRejectedEvent domainEvent = new(templateId, providerId);
        ...
        _loggerMock.Verify(
            ...
            Times.Once,
            "The handler failed to execute the warning level structured logging protocol containing both the TemplateId and ProviderId exactly once.");
    }
